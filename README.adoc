...
Create CustomResourceDefinitions and ClusterRoles defined in the `install/` directory:

---------------------
oc apply -Rf install/
---------------------

Create a new project namespace to deploy Anarchy:
...
--------------------------------------------------------------------------------
oc process -f https://raw.githubusercontent.com/redhat-cop/anarchy/master/deploy-template.yaml | oc apply -f -
--------------------------------------------------------------------------------
...
----
kubectl create namespace anarchy
----

Install with Helm

----
helm install --namespace anarchy anarchy helm/
----
