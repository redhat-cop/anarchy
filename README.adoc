...
+
----
oc process -f deploy-template.yaml | oc apply -n anarchy-operator -f -
----
...
oc process -f deploy-template.yaml -p OPERATOR_IMAGE=$OPERATOR_IMAGE | oc apply -n anarchy-operator -f -
----
