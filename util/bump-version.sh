...
sed -i "s/^version: .*/version: ${VERSION:1}/" helm/Chart.yaml examples/*/helm/Chart.yaml
sed -i "s/^appVersion: .*/appVersion: ${VERSION:1}/" helm/Chart.yaml examples/*/helm/Chart.yaml
